...
describe('JwtStrategy', () => {
    ...
    beforeEach(() => {
        mockUsersService = new UsersService({} as any, {} as any) as jest.Mocked<UsersService>;
        mockConfigService = {
    ...
    describe('validate', () => {
        it('should return a user if validation is successful', async () => {
            const mockPayload = { email: 'test@example.com', id: 1, username: 'testuser', role: UserRole.USER };
